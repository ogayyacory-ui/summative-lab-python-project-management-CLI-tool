...
If you are not using Pipenv, install the packages from `requirements.txt` and
...
python main.py add-project --user Ada --title CLI --description "Build tracker" --due-date 2026-06-30
python main.py add-task --project CLI --title "Write tests" --assigned-to Ada
